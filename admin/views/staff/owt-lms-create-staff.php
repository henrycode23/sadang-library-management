...
<?php
                // if (count($params['total_staffs']) > 0) {
                    ?>
                    <!-- <div class="alert alert-danger">
                        <b>Staffs limit exceeded, Please contact plugin administrator for paid version.</b>
                    </div> -->
                    <?php
                // } else {
                    ?>
                ...
                <form action="javascript:void(0)" id="wpowt-lib-frm-create-new-staff" method="post">
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" value="<?php echo isset($params['staff_data']['email']) ? esc_attr($params['staff_data']['email']) : ''; ?>" id="txt-email" name="txt_email" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="txtphone">Phone</label>
                            <input type="text" class="form-control" value="<?php echo isset($params['staff_data']['phone_no']) ? esc_attr($params['staff_data']['phone_no']) : ''; ?>" id="txt-phone" name="txt_phone" placeholder="Enter phone">
                        </div>
                        <div class="form-group">
                            ...
                            <img src="<?php echo isset($params['staff_data']['profile_image']) ? esc_attr($params['staff_data']['profile_image']) : OWT_LIBRARY_PLUGIN_URL . 'assets/images/blank-user.png'; ?>" class="wpowt-lib-img-prev"/>
