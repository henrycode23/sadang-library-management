...
<?php
                // if ($params['total_students'] > 5) {
                    ?>
                    <!-- <div class="alert alert-danger">
                        <b>Students limit exceeded, Please contact Plugin administrator for paid version.</b>
                    </div> -->
                    <?php
                // } else {
                    ?>
                ...
                <form action="javascript:void(0)" id="wpowt-lib-frm-create-new-student" method="post">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txt-phone" value="<?php echo isset($params['student_data']['phone_no']) ? esc_attr($params['student_data']['phone_no']) : ""; ?>" name="txt_phone" placeholder="Enter phone">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo isset($params['student_data']['father_name']) ? esc_attr($params['student_data']['father_name']) : ""; ?>" id="txt-father-name" name="txt_father_name" placeholder="Enter father name">
                        </div>
                        <div class="form-group">
                            <label for="txtmothername">Mother's name</label>
                            <input type="text" class="form-control" id="txt-mother-name" value="<?php echo isset($params['student_data']['mother_name']) ? esc_attr($params['student_data']['mother_name']) : ""; ?>" name="txt_mother_name" placeholder="Enter mother name">
                        </div>
                        <div class="form-group">
                            <label for="txtphone">Parent's Phone</label>
                            <input type="text" class="form-control" id="txt-parent-phone" name="txt_parent_phone" value="<?php echo isset($params['student_data']['parent_phone_no']) ? esc_attr($params['student_data']['parent_phone_no']) : ""; ?>" placeholder="Enter parent phone">
                        </div>
                        <div class="form-group">
                            ...
                            <img src="<?php echo isset($params['student_data']['profile_image']) ? esc_attr($params['student_data']['profile_image']) : OWT_LIBRARY_PLUGIN_URL . 'assets/images/blank-user.png'; ?>" class="wpowt-lib-img-prev"/>
