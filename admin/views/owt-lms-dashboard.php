        ...
        <div class="col-md-12 owt-left-panel-body">
            <div class="col-md-3 owt-col-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Total Students: <?php echo $params['students']; ?></p>
            ...
            <div class="col-md-3 owt-col-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Total Management Staffs: <?php echo $params['staffs']; ?></p>
            ...
            <div class="col-md-3 owt-col-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Total Books: <?php echo $params['books']; ?></p>
            ...
            <div class="col-md-3 owt-col-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <h5 class="wpowt-label-bold">Manage Book Issue/Return</h5>
                        <p>Issued to Students / Staffs: <?php echo $params['issue_to_students']; ?> / <?php echo $params['issue_to_staffs']; ?></p>
