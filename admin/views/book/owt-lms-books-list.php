                        ...
                        if (isset($params['books']) && count($params['books']) > 0) {
                            ...
                            foreach ($params['books'] as $index => $book) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="admin.php?page=owt-lib-create-book&action=edit&bid=<?php echo $book->id ?>" class='btn btn-info wpowt-lib-btn'><i class="mdi mdi-pencil"></i></a>
                                        <a href="javascript:void(0)" class='btn btn-danger wpowt-lib-del-book wpowt-lib-btn' data-id="<?php echo $book->id; ?>"><i class="mdi mdi-trash-can-outline"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
