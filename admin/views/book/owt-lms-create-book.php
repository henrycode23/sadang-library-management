    ...
    <div class="row owt-inner-row">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="javascript:void(0)" <?php
                if (isset($params['rule']) && $params['rule']) {
                    echo 'class="wpowt-add-frm-point"';
                } else {
                    echo 'id="wpowt-lib-frm-create-new-book"';
                }
                ?>  method="post">
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo isset($params['book_data']['amount']) ? esc_attr($params['book_data']['amount']) : ''; ?>"  id="txtamount" name="txtamount" placeholder="Enter Amount">
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="form-group">
